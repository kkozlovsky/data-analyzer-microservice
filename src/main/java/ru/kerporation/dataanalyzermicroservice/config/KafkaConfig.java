...
public class KafkaConfig {
    ...
    public ReceiverOptions<String, Object> receiverOptions() {
        final ReceiverOptions<String, Object> receiverOptions = ReceiverOptions.create(receiverProperties());
    ...
    @Bean
    public KafkaReceiver<String, Object> receiver(final ReceiverOptions<String, Object> receiverOptions) {
